...
import (
	...
	"github.com/param-jeet-singh/go-redis/extra/rediscmd/v9"
	"github.com/param-jeet-singh/go-redis/v9"
)

const (
	instrumName = "github.com/param-jeet-singh/go-redis/extra/redisotel"
)
...
func (th *tracingHook) ProcessHook(hook redis.ProcessHook) redis.ProcessHook {
	return func(ctx context.Context, cmd redis.Cmder) error {
		...
		fn, file, line := funcFileLine("github.com/param-jeet-singh/go-redis")
